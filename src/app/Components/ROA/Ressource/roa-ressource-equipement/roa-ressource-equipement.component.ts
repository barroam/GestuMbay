...
@Component({
  selector: 'app-roa-ressource-equipement',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './roa-ressource-equipement.component.html',
  styleUrl: './roa-ressource-equipement.component.css'
})
export class RoaRessourceEquipementComponent implements OnInit {
