...
@Component({
  selector: 'app-roa-ressource-semences',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './roa-ressource-semences.component.html',
  styleUrl: './roa-ressource-semences.component.css'
})
export class RoaRessourceSemencesComponent  implements OnInit {
  semences: Semences[] = [];
