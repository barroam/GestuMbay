...
@Component({
  selector: 'app-roa-contrats-add-update',
  standalone: true,
  imports: [CommonModule,FormsModule,ReactiveFormsModule],
  templateUrl: './roa-contrats-add-update.component.html',
  styleUrl: './roa-contrats-add-update.component.css'
})
export class ROAContratsAddUpdateComponent  implements OnInit {
