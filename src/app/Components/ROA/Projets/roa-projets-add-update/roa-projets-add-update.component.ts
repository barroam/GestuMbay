...
@Component({
  selector: 'app-roa-projets-add-update',
  standalone: true,
  imports: [CommonModule,RouterLink,ReactiveFormsModule,FormsModule],
  templateUrl: './roa-projets-add-update.component.html',
  styleUrl: './roa-projets-add-update.component.css'
})
export class ROAProjetsAddUpdateComponent implements OnInit {
