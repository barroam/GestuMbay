...
@Component({
  selector: 'app-roa-projets-show',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule,FormsModule,RouterLink],
  templateUrl: './roa-projets-show.component.html',
  styleUrl: './roa-projets-show.component.css'
})
export class ROAProjetsShowComponent implements OnInit {
