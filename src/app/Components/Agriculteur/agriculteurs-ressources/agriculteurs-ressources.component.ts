...
@Component({
  selector: 'app-agriculteurs-ressources',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule,RouterLink],
  templateUrl: './agriculteurs-ressources.component.html',
  styleUrl: './agriculteurs-ressources.component.css'
})
export class AgriculteursRessourcesComponent implements OnInit {
  semences: any[] = [];
  engrais: any[] = [];
  equipements: any[] = [];
  errorMessage: string = '';
